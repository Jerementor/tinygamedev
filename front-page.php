...
<div class="flex-child-main">
  <div class="w-container">
    <h1 class="home-header">Complete Your Games</h1>
    <h1 class="home-sub">Learn (Tiny) Development Today</h1>
    <div class="div-block-9">
        <a href="/screencasts" class="button-red w-button">Browse Screencasts</a>
        <a href="/tutorials" class="button w-button">View Tutorials</a></div>
  </div>
</div>
<div class="brands">
  <div class="w-container">
